...
class PrinterUseCase(private val applicationContext: Context) {
    ...
    private val spasibo = "Vielen Dank für Ihren Besuch"
...
//            printer.addFeedLine(1)
            ...
            printer.addHLine(0, 420, Printer.PARAM_DEFAULT)
...
//                    printer.addTextAlign(Printer.ALIGN_RIGHT)
            ...
            printer.addHLine(0, 420, Printer.LINE_MEDIUM)
            printer.addTextAlign(Printer.ALIGN_LEFT)
            printer.addTextFont(Printer.FONT_B)
            printer.addTextSize(1, 2)
            ...
            printer.addTextFont(Printer.FONT_A)
            printer.addTextAlign(Printer.ALIGN_CENTER)
            printer.addText("Vielen Dank für Ihren Besuch")
            //=======================================================
            printer.addFeedLine(1)
            //=======================================================
            printer.addTextSize(1, 1)
            printer.addTextFont(Printer.FONT_A)
            printer.addText("St.-Nr.: DE287282566")
